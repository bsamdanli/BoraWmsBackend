...
{
    public abstract class BoraWmsNewWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BoraWmsNewWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BoraWmsNewWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BoraWmsNewDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BoraWmsNewDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BoraWmsNewDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BoraWmsNewDbContext, Task<T>> func)
        {
            T result;
